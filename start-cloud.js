// Railway/PostgreSQL startup shim for Coffee POS v1.5.2.
...
source = source.replace(/const APP_VERSION = '[^']+';/, "const APP_VERSION = '1.5.2';");
...
if (!source.includes('Delivered By is required. Enter who will deliver the stock.') ||
  ...
  throw new Error('Coffee POS v1.5.2 startup patch could not find the expected inventory validation code.');
}
