// Railway/PostgreSQL startup shim for Coffee POS v1.5.0.
...
source = source.replace(/const APP_VERSION = '[^']+';/, "const APP_VERSION = '1.5.0';");
...
if (!source.includes('Delivered By is required. Enter who will deliver the stock.') ||
  ...
  throw new Error('Coffee POS v1.5.0 startup patch could not find the expected inventory validation code.');
}
