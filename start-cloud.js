// Railway/PostgreSQL startup shim for Coffee POS v1.5.3.
...
source = source.replace(/const APP_VERSION = '[^']+';/, "const APP_VERSION = '1.5.3';");
...
if (!source.includes('Delivered By is required. Enter who will deliver the stock.') ||
  ...
  throw new Error('Coffee POS v1.5.3 startup patch could not find the expected inventory validation code.');
}
